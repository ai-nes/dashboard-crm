...
function errorMessage(error: unknown): string {
  return error instanceof Error && error.message
    ? error.message
    : "Không thể tải danh mục phương thức xét tuyển.";
}
    ...
    <>
      ...
      >
        <p className="text-sm text-text-secondary">
          Chỉ phương thức chưa được sử dụng mới có thể xóa. Nếu đang được dùng,
          hãy tắt phương thức thay vì xóa.
        </p>
      </DeleteRecordDialog>
    </>
  );
...
function CatalogLoading() {
  return (
    <div
      ...
      aria-label="Đang tải danh mục phương thức xét tuyển"
    >
      <p className="text-sm text-text-tertiary">
        Đang tải danh mục phương thức xét tuyển…
      </p>

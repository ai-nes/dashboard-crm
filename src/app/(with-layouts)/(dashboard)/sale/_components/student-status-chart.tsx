...
import { studentStatusData } from "./data";
    ...
    <Card className="min-w-0 p-5 sm:p-6">
      <CardHeader className="items-start">
        <div>
          ...
          <p className="mt-1 text-xs leading-5 text-text-tertiary">Phân bổ {totalStudents} học sinh bạn đang phụ trách.</p>
        </div>
      ...
      <div className="relative mx-auto mt-3 h-52 w-full max-w-60" role="img" aria-label={`Biểu đồ donut trạng thái ${totalStudents} học sinh`}>

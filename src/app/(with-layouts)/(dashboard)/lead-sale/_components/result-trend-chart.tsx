...
import type { ResultTrendPoint } from "./data";
...
export default function ResultTrendChart({
  ...
  ranges: Record<TrendRange, ResultTrendPoint[]>;
  ...
  return (
    <Card className="min-w-0 p-5 sm:p-6">
      <CardHeader className="items-start gap-3">
        <div>
          ...
          <p className="mt-1 text-xs leading-5 text-text-tertiary">
            Kết quả tư vấn và nhập học của cả đội theo thời gian.
          </p>
        </div>
        <Select
          value={range}
      ...
      <div
        ...
        role="img"
        aria-label={`Biểu đồ xu hướng kết quả trong ${range === "4w" ? "4 tuần" : "3 tháng"}`}
      >
        <ChartContainer
        ...
        >
          ...
          >
            ...
            <Tooltip
              ...
              content={<ResultTrendTooltip />}
            />
            <Line
              type="monotone"
              dataKey="consulted"
              name="Tư vấn hoàn tất"

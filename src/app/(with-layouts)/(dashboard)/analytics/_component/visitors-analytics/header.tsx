...
import { VisitorsAnalyticsStatSkeleton } from "./skeleton";
...
type HeaderSectionProps = {
  isLoading: boolean;
  chartData?: VisitorsAnalyticsViewModel;
  stats: Array<{
    id: string;
    label: string;
    value: string;
  ...
  timeRange: AnalyticsGranularity;
  setTimeRange: (value: AnalyticsGranularity) => void;
};
...
export default function HeaderSection({
  ...
  return (
    <CardHeader className="mb-6 flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
      ...
      <div>
        <Select
          onChange={(value) => setTimeRange(value as AnalyticsGranularity)}
          value={timeRange}
        ...
        >
          ...
          <SelectContent>
            <SelectItem textValue="weekly" id="weekly">
              Weekly
            </SelectItem>

...
export function VisitorsAnalyticsStatSkeleton() {
  return (
...
export default function VisitorsAnalyticsSkeleton() {
  return (
    <div className="h-75 w-full border-b border-dashed border-border-secondary-alt p-0">
      <svg
      ...
      >
        <defs>
          <linearGradient id="analytics-b" x1={0} y1={0} x2={1} y2={0}>
          ...
          <linearGradient id="analytics-a" x1={0} y1={0} x2={0} y2={1}>

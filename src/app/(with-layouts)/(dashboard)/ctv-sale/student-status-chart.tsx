...
import type { CtvSaleStudentStatus } from "@/services/api/ctv-sale";

import { STATUS_COLORS } from "./_components/data";
      ...
      <CardHeader className="items-start">
        <div>
          ...
          <p className="mt-1 text-xs leading-5 text-text-tertiary">
            Phân bổ hồ sơ đang phụ trách.
          </p>
        </div>
        <span className="rounded-full bg-background-soft-50 px-2.5 py-1 text-[11px] font-medium text-text-secondary">
          Tổng quan
        </span>
      </CardHeader>

      <div
        className="relative mx-auto mt-3 h-52 w-full max-w-60"
        role="img"
        aria-label={`Biểu đồ donut trạng thái ${data.total} hồ sơ học sinh`}
      >
        <ChartContainer

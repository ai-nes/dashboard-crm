...
export function LeadGrowthStatSkeleton() {
  return (
...
export default function LeadGrowthChartSkeleton() {
  return (
    <div className="h-67.5 w-full border-b border-dashed border-border-secondary-alt p-0">
      ...
      >
        <defs>
          <linearGradient id="crm-lg-b" x1={0} y1={0} x2={1} y2={0}>
          ...
          <linearGradient id="crm-lg-a" x1={0} y1={0} x2={0} y2={1}>

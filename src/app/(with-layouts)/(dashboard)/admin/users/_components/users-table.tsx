...
export default function UsersTable({
  ...
  return (
    <TableRoot fullBleed className="border-0" aria-label="Danh sách người dùng CRM">
      ...
      <TableBody>
        ...
        {!isLoading && users.length === 0 ? (
          <TableRow>
            <TableCell colSpan={columnCount} className="py-16 text-center text-sm text-text-tertiary">
              {total === 0
                  ...
                  <TableCell className="py-4">
                    <div className="flex min-w-0 items-center gap-2.5">
                      ...
                      <div className="min-w-0">
                        <p title={user.fullName} className="truncate text-sm font-medium text-text-primary">
                          {user.fullName}
                          {user.sessionUser ? (
                            <span className="ml-1.5 text-xs font-normal text-text-tertiary">(Bạn)</span>
                          ) : null}
                        </p>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="py-4 text-sm text-text-secondary">{user.email}</TableCell>
                    ...
                    <TableCell className="py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          isDisabled={isMutating || isSystemManager || user.sessionUser}

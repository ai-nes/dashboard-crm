...
export default function RegionalDemandHeatmap() {
  return (
    <Card className="min-w-0 overflow-hidden bg-card-background p-0">
      <CardHeader className="border-b border-card-border p-5"><div><CardTitle>Mức độ quan tâm theo ngành và địa bàn</CardTitle><p className="mt-1 text-xs leading-5 text-text-tertiary">Màu đậm hơn = nhiều học sinh quan tâm hơn.</p></div><span className="text-xs text-text-tertiary">Điểm 0–100</span></CardHeader>

  ...
  return (
    <article className="flex h-full min-w-0 flex-col rounded-2xl bg-background-gray-primary p-4">
      <div className="flex items-center justify-between gap-3">
        <span className={`flex size-8 shrink-0 items-center justify-center rounded-lg text-xs font-semibold ${toneStyles[dimension.tone]}`} aria-hidden="true">{String(index + 1).padStart(2, "0")}</span>

...
export default function SchoolReportHeader({
  region,
  onRegionChange,
  onCreateSchool,
}: SchoolReportHeaderProps) {
  return (
    <header className="flex flex-col gap-5 rounded-xl border border-card-border bg-card-background p-5 lg:flex-row lg:items-end lg:justify-between lg:p-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-text-secondary">
          Ưu tiên địa bàn và nhóm trường có tiềm năng cao để phân bổ nguồn lực
          tuyển sinh.
        </p>
      </div>
      <div className="flex flex-wrap items-center gap-2">
        {onCreateSchool && (
          <Button size="sm" onPress={onCreateSchool}>
        ...
        <Select
          className="w-auto"
          value={region}
          onChange={(value) => onRegionChange(value as SchoolRegion | "all")}
          aria-label="Lọc báo cáo theo miền"
        >
          ...
          <SelectContent>
            <SelectItem id="all" textValue="Toàn quốc">
              Toàn quốc
            </SelectItem>
            <SelectItem id="Miền Bắc" textValue="Miền Bắc">
              Miền Bắc
            </SelectItem>
            <SelectItem id="Miền Trung" textValue="Miền Trung">
              Miền Trung
            </SelectItem>
            <SelectItem id="Miền Nam" textValue="Miền Nam">
              Miền Nam
            </SelectItem>
          </SelectContent>
        </Select>
